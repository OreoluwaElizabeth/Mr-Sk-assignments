...
from snack_func import maximum
from snack_func import squared
from snack_func import sum_of_squares
...
def test_squared_function():
	numbers = [2, 3, 4, 5, 7]
	assert squared(numbers) == [4, 9, 16, 25, 49]

def test_sum_of_squares_function():
	numbers = [2, 3, 4, 5, 7]
	assert sum_of_squares(numbers) == 103
